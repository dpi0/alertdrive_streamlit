...
class AudioFrameHandler:
    def __init__(self, sound_file_path: str = ""):
        self.custom_audio = AudioSegment.from_file(
            file=sound_file_path, format="wav"
        )
    ...
    def prepare_audio(self, frame: av.AudioFrame):
        ...
        self.custom_audio = self.custom_audio.set_frame_rate(
            sound.frame_rate
        )
        self.custom_audio = self.custom_audio.set_sample_width(
            sound.sample_width
        )
    ...
    def process(self, frame: av.AudioFrame, play_sound: bool = False):
        ...
        channel_samples = [
            s.get_array_of_samples() for s in channel_sounds
        ]
